...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x077167ff154a83fa, ; from name: aot-Apptech.dll.so
		i64 u0xbca73d258e6289e5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Apptech.dll.so
		ptr null; void* handle
	}, ; 22
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x10f7558a1a23aa22, ; from name: Apptech.so
		i64 u0xbca73d258e6289e5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Apptech.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x49291143ac1f78ab, ; from name: aot-Apptech
		i64 u0xbca73d258e6289e5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Apptech.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5c09528bf714faae, ; from name: Apptech.dll.so
		i64 u0xbca73d258e6289e5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Apptech.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7bc12afea1bf8940, ; from name: aot-Apptech.so
		i64 u0xbca73d258e6289e5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Apptech.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb5957d51657d1e12, ; from name: libaot-Apptech
		i64 u0xbca73d258e6289e5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Apptech.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xbca73d258e6289e5, ; from name: libaot-Apptech.dll.so
		i64 u0xbca73d258e6289e5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Apptech.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf5b5ae33270af786, ; from name: libaot-Apptech.so
		i64 u0xbca73d258e6289e5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Apptech.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf6b94928b57c6a54, ; from name: Apptech
		i64 u0xbca73d258e6289e5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Apptech.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.apptech\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [22 x i8] c"libaot-Apptech.dll.so\00", align 16
